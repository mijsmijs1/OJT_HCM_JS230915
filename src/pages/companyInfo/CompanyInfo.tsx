...
import { fetchCompanyById, fetchCompanyByType } from '@/store/slices/company/company.slice';
...
export default function CompanyInfo() {
  ...
  useEffect(() => {
    if (companyStore.company) {
      dispatch(fetchCompanyByType(companyStore.company?.type_company?.id || 0) as any)
    }
      ...
      <div className='content'>
        <div className='header'>
          <div className='header_left'>
            {companyStore.loadingCompany ? <Skeleton.Image active></Skeleton.Image> : <div className='logo'><img src={companyStore.company?.logo} alt='logo' /></div>}
