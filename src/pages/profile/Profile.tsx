    ...
    return (
        <div className='profile_container'>
            <div className='content'>
                ...
                <div className='profile_content'>
                    <div className='box_content_right'>
                        ...
                        <div className='profile_content_button'>
                            <button className='button-review'>Xem và tải </button>
                        </div>
                    </div>
                ...
                {
                    openModalInfo && <div id="myModal" className="modal">
                ...
                {/* <!-- The Modal-Review-HV --> */}
                {
                    openModalHV && <div id="myModal" className="modal">
