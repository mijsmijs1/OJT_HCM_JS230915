...
import { fetchCompanies } from '@/store/slices/company.slice'
                        ...
                        <div className='profile_content_info_company company'>
                            ...
                            <div className='box_profile_content_info'>
                                <div className='box_profile_content_info_logo'>
                                    <img style={{ cursor: "pointer" }} src={companyStore.data?.avatar} alt="" />
                                </div>

                                {
                                    companyStore.data && (
                                        <div className='profile_content_info_user'>
                                            <h2>{companyStore.data?.displayName}</h2>
